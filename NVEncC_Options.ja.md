...
### --nvj2k
avformatでdemux、nvJPEG2000 CUDAでJPEG 2000をデコードして読み込む。8bit、10bit、12bit、16bitのJPEG 2000入力に対応。avformatはdemux、timestamp、音声、字幕、データストリーム、attachmentの処理に使用し、JPEG 2000映像packetはCUDAで直接NVEnc用のGPU surfaceへデコードする。
